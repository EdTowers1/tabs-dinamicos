...
class UTabulator {
  ...
  Filter(cId_Filter, aFields) {
    ...
    cHtml += '<select class="form-control" id="' + cId_Filter + '_' + 'filter-field">' + '<option></option>'
    ...
    cHtml +=
      '<input class="form-control" id="' + cId_Filter + '_' + 'filter-value" type="text" placeholder="value to filter">'
    ...
    cHtml +=
      " $('#" +
      cId_Filter +
      "_filter-field' ).bind('change', function() { UTabulatorFilterUpdate( '" +
      this.id +
      "','" +
      cId_Filter +
      "' ) } );"
    cHtml +=
      " $('#" +
      cId_Filter +
      "_filter-type'  ).bind('change', function() { UTabulatorFilterUpdate( '" +
      this.id +
      "','" +
      cId_Filter +
      "' ) } );"
    cHtml +=
      " $('#" +
      cId_Filter +
      "_filter-value' ).bind('keyup' , function() { UTabulatorFilterUpdate( '" +
      this.id +
      "','" +
      cId_Filter +
      "' ) } );"
    cHtml +=
      " $('#" +
      cId_Filter +
      "_filter-clear' ).bind('click' , function() { UTabulatorFilterClear ( '" +
      this.id +
      "','" +
      cId_Filter +
      "' ) } );"
